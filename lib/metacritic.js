...
export async function getFeaturedPrendas() {
    const API_URL = "http://192.168.18.21:1337/api/prendas/?filters[esDestacado][$eq]=true&populate[imagen]=*&populate[categoria]=*&populate[tallas][populate]=*&populate[marca]=*";
